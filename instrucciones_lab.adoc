...
----
[root@hipervisoramapm ~]#subscription-manager register --username=test-drive --password='redhat2018' --force
----

----
[root@hipervisoramapm ~]# subscription-manager attach --pool=8a85f98160e6119c0160e901f57f767f
----

----
[root@hipervisoramapm ~]# subscription-manager repos --disable=*
----
...
----
----
[root@hipervisoramapm ~]# yum update -y
----
...
----
[root@hipervisoramapm ~]# yum install cockpit-ovirt-dashboard
Loaded plugins: product-id, search-disabled-repos, subscription-manager
Resolving Dependencies
--> Running transaction check
...
----
[root@hipervisoramapm ~]# systemctl enable cockpit.socket
Created symlink from /etc/systemd/system/sockets.target.wants/cockpit.socket to /usr/lib/systemd/system/cockpit.socket.

[root@hipervisoramapm ~]# systemctl start cockpit.socket
----

=== Modificar hostname de equipo RHV-H
----
[root@hipervisoramapm ~]# hostnamectl set-hostname hiper1.example.com
----
